...
@section('content')
    ...
    <div class="card-elegant p-6 animate-entry delay-100">
        <form action="{{ route('departures.store') }}" method="POST" class="space-y-8">
            @csrf

            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <!-- Barco -->
                <div>
                    <label for="boat_id" class="block text-sm font-medium text-gray-700 mb-2">Barco</label>
                    <div class="relative">
            ...
            <div class="flex justify-end gap-4 pt-6 border-t border-gray-100">
                ...
                <button type="submit" class="btn-primary px-6 py-2.5 text-sm font-medium text-white tracking-wide">Crear Salida</button>
            </div>
        </form>
    </div>
@endsection