        ...
        <form action="{{ route('departures.update', $departure) }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="datetime-local" name="departure_at" id="departure_at" class="form-input" value="{{ old('departure_at', \Carbon\Carbon::parse($departure->departure_at)->format('Y-m-d\TH:i')) }}" required>
                        <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                            <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="text" name="departure_port" id="departure_port" class="form-input" value="{{ old('departure_port', $departure->departure_port) }}" required>
                        <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                            <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="price_per_person" id="price_per_person" class="form-input pl-7" value="{{ old('price_per_person', $departure->price_per_person) }}" step="0.01" min="0" required>
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="number" name="reserved_passengers" id="reserved_passengers" class="form-input" value="{{ old('reserved_passengers', $departure->reserved_passengers) }}" min="0">
                        <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                            <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
