        ...
        <form action="{{ route('departures.update', $departure) }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="price_per_person" id="price_per_person" class="form-input" value="{{ old('price_per_person', $departure->price_per_person) }}" step="0.01" min="0" required>
