                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex w-full items-center justify-end gap-2">
                                    <a href="{{ route('departures.edit', $departure) }}" class="text-gray-400 hover:text-gray-900 transition-colors p-1.5 flex items-center justify-center">
                                    ...
                                    <form action="{{ route('departures.destroy', $departure) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="text-gray-400 hover:text-red-600 transition-colors p-1.5 flex items-center justify-center" onclick="return confirm('¿Estás seguro de eliminar esta salida?')">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
